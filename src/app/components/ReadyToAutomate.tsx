    ...
    <section className="py-24 md:py-32 px-6 text-center relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto">
        <h2 className="text-4xl md:text-7xl font-black uppercase tracking-tighter mb-6 leading-[0.9]">
          Want Me Embedded<br/>As Your Automation Partner?
        </h2>
        <p className="text-gray-400 text-lg md:text-xl mb-10 max-w-2xl mx-auto leading-relaxed">
          Beyond one-off builds, I stay on as your dedicated automation architect — maintaining, fixing, and scaling your GHL account and AI systems as your business grows. Fully white-label, always.
        </p>

        <div className="flex flex-col md:flex-row gap-5 justify-center">
          <button
            type="button"
            onClick={() => openModal('embedded-partner-1200')}
            className="bg-blue-600 text-white px-10 py-5 rounded-2xl font-black uppercase tracking-widest hover:bg-blue-700 hover:scale-105 transition-all shadow-xl shadow-blue-600/20"
          >
            Become a Partner Client
          </button>
